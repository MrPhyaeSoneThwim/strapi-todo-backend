...
const getTypes = require("@strapi/plugin-users-permissions/server/graphql/types");
const getQueries = require("@strapi/plugin-users-permissions/server/graphql/queries");
